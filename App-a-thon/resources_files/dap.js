...
{var c=document.cookie;var mh=escape(dapExtractValue(c,'mh',';'));var qs=(mh!='')?'&PN='+mh:'';var id=escape(dapExtractValue(dapExtractValue(c,'ANON',';'),'A','&'));var muid=escape(dapExtractValue(c,'MUID',';'));if(id=='')
{id=muid;}
